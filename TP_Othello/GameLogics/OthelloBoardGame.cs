...
namespace TP_Othello.GameLogics
{
    ...
    /// </summary>
    class OthelloBoardGame : IPlayable.IPlayable, INotifyPropertyChanged, ISerializable
    {
        ...
        public OthelloBoardGame(BoardView boardView, MainWindow windowView) : this()
        {
        ...
        private OthelloBoardGame(SerializationInfo info, StreamingContext context) : this()
        {
